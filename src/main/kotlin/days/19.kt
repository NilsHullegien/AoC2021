...
// https://github.com/ClouddJR/AdventOfCode2021/blob/45c1d6ef22d700a67b220f33eb6687c6ef1b6884/src/main/kotlin/com/clouddjr/advent2021/Day19.kt
fun main() {
    run19a()
    run19b()
}

private val scanners = File("src/main/resources/19/19-input.txt").readText()
...
fun run19a() {
    println(assembleMap().beacons.size)
}

fun run19b() {
    println(assembleMap().scannersPositions.let {positions -> positions.flatMapIndexed {
        index, first -> positions.drop(index + 1).map {second -> first to second}
